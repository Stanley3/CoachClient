...
public class PracticerFinishRecycleAdapter extends RecycleBaseAdapter {

	public PracticerFinishRecycleAdapter() {
		super();
	}
	public PracticerFinishRecycleAdapter(View headerView){
	...
	protected void onBindItemViewHolder(RecycleBaseAdapter.ViewHolder vh, int position) {
		...
		PracticerFinishRecycleAdapter.ViewHolder holder= (ViewHolder) vh;
